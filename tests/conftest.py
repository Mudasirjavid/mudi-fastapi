...
# SQLACHEMY_DATABASE_URL='postgresql://postgres:photomath4321@localhost:5432/fastapi_test'
...
def test_user2(client):
    user_data = {"email": "testkhan123@gamil.com", "password": "testpassword"}
...
def test_user(client):
    user_data = {"email": "testkhan@gamil.com", "password": "testpassword"}
    res = client.post("/users/", json=user_data)
    assert res.status_code == 201
    new_user = res.json()
    new_user["password"] = user_data["password"]
